...
(function(){
  const translations = {
    es: {
      ...
      "nav.gallery": "Galería interactiva",
      "nav.subscribe": "Suscripción",
      "nav.discover": "Descubra Costa Rica",
      "nav.wildlife": "Galería de vida silvestre",
      ...
      "about-p1": "Perezosos Pura vida es una empresa de turismo con soluciones inmersivas a sus vacaciones, le recomendamos las vacaciones perfectas mediante una experiencia única y completamente inmersiva para que pueda empezar a disfrutar de las bellezas de Costa Rica incluso antes de iniciar el viaje!",
      "about-p2": "1: Puede seleccionar la experiencia inmersiva o agendar una cita de 20 minutos sin costo para conocer más de nuestros servicios. La cita está sujeta a disponibilidad del personal.",
      "about-p3": "2: También puede dejarnos su correo electrónico de contacto y con gusto le podemos enviar más información a su correo.",
    ...
    en: {
      "nav.about": "About us",
      "nav.contact": "Contact",
      "nav.gallery": "Interactive gallery",
      "nav.subscribe": "Subscription",
      "nav.discover": "Discover Costa Rica",
      "nav.wildlife": "Wildlife gallery",
      "nav.feedback": "Feedback",
      "nav.testimonials": "Testimonials",
      "nav.externalResources": "External resources",
      "banner.subtitle": "Interactive Tourism and Travel Recommendations",
      "about.title": "About Us",
      "about-p1": "Perezosos Pura Vida is a tourism company offering immersive solutions for your vacation. We recommend the perfect holiday through a unique and fully immersive experience, so you can start enjoying the beauty of Costa Rica even before your trip begins!",
      "about-p2": "1: You can select the immersive experience or schedule a free 20-minute appointment to learn more about our services. The appointment is subject to staff availability.",
      "about-p3": "2: You can also leave us your contact email, and we will gladly send you more information.",
